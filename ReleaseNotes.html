...
<div class="content">
<h1>Git for Windows v2.50.1 Release Notes</h1>

<p>Latest update: July 8th 2025</p>
...
<ul>
<li>On Windows 10 before 1703, or when Developer Mode is turned off, special permissions are required when cloning repositories with symbolic links, therefore support for symbolic links is disabled by default. Use <code>git clone -c core.symlinks=true &lt;URL&gt;</code> to enable it, see details <a href="https://gitforwindows.org/symbolic-links">here</a>.</li>
...
</div><h2 id="v2.50.1" nr="1" class="collapsible"> <a name="latest">Changes in v2.50.1</a><br /><small>since  v2.50.0(2) (July 1st 2025)</h2></small><div>

<p>This is a security fix release, addressing CVE-2024-50349, CVE-2024-52006, CVE-2025-27613, CVE-2025-27614, CVE-2025-46334, CVE-2025-46835, CVE-2025-48384, CVE-2025-48385, and CVE-2025-48386.</p>

<h3>New Features</h3>

<ul>
<li>Comes with <a href="https://github.com/git/git/blob/v2.50.1/Documentation/RelNotes/2.50.1.adoc">Git v2.50.1</a>.</li>
</ul>

<h3>Bug Fixes</h3>

<ul>
<li><a href="https://github.com/j6t/gitk/security/advisories/GHSA-f3cw-xrj3-wr2v"><strong>CVE-2025-27613</strong></a>, Gitk: When a user clones an untrusted repository and runs Gitk without additional command arguments, any writable file can be created and truncated. The option "Support per-file encoding" must have been enabled. The operation "Show origin of this line" is affected as well, regardless of the option being enabled or not.</li>
<li><a href="https://github.com/j6t/gitk/security/advisories/GHSA-g4v5-fjv9-mhhc"><strong>CVE-2025-27614</strong></a>, Gitk: A Git repository can be crafted in such a way that a user who has cloned the repository can be tricked into running any script supplied by the attacker by invoking <code>gitk filename</code>, where <code>filename</code> has a particular structure.</li>
<li><a href="https://github.com/j6t/git-gui/security/advisories/GHSA-7px4-9hg2-fvhx"><strong>CVE-2025-46334</strong></a>, Git GUI (Windows only): A malicious repository can ship versions of sh.exe or typical textconv filter programs such as astextplain. On Windows, path lookup can find such executables in the worktree. These programs are invoked when the user selects "Git Bash" or "Browse Files" from the menu.</li>
<li><a href="https://github.com/j6t/git-gui/security/advisories/GHSA-xfx7-68v4-v8fg"><strong>CVE-2025-46835</strong></a>, Git GUI: When a user clones an untrusted repository and is tricked into editing a file located in a maliciously named directory in the repository, then Git GUI can create and overwrite any writable file.</li>
<li><a href="https://github.com/git/git/security/advisories/GHSA-vwqx-4fm8-6qc9"><strong>CVE-2025-48384</strong></a>, Git: When reading a config value, Git strips any trailing carriage return and line feed (CRLF). When writing a config entry, values with a trailing CR are not quoted, causing the CR to be lost when the config is later read.  When initializing a submodule, if the submodule path contains a trailing CR, the altered path is read resulting in the submodule being checked out to an incorrect location. If a symlink exists that points the altered path to the submodule hooks directory, and the submodule contains an executable post-checkout hook, the script may be unintentionally executed after checkout.</li>
<li><a href="https://github.com/git/git/security/advisories/GHSA-m98c-vgpc-9655"><strong>CVE-2025-48385</strong></a>, Git: When cloning a repository Git knows to optionally fetch a bundle advertised by the remote server, which allows the server-side to offload parts of the clone to a CDN. The Git client does not perform sufficient validation of the advertised bundles, which allows the remote side to perform protocol injection. This protocol injection can cause the client to write the fetched bundle to a location controlled by the adversary. The fetched content is fully controlled by the server, which can in the worst case lead to arbitrary code execution.</li>
<li><a href="https://github.com/git/git/security/advisories/GHSA-4v56-3xvj-xvfr"><strong>CVE-2025-48386</strong></a>, Git: The wincred credential helper uses a static buffer (<code>target</code>) as a unique key for storing and comparing against internal storage. This credential helper does not properly bounds check the available space remaining in the buffer before appending to it with <code>wcsncat()</code>, leading to potential buffer overflows.</li>
</ul>

</div><h2 id="v2.50.0(2)" nr="2" class="collapsible"> Changes in v2.50.0(2)<br /><small>since  v2.50.0 (June 16th 2025)</h2></small><div>

<h3>New Features</h3>

<ul>
<li>Comes with <a href="https://github.com/git-lfs/git-lfs/releases/tag/v3.7.0">Git LFS v3.7.0</a>.</li>
</ul>

<h3>Bug Fixes</h3>

<ul>
<li>Cloning large repositories via SSH <a href="https://github.com/git-for-windows/git/issues/5688">frequently hung with Git for Windows v2.50.0</a>, which <a href="https://github.com/git-for-windows/msys2-runtime/pull/103">was fixed</a>.</li>
<li>In Git for Windows v2.50.0, operations using the POSIX emulation layer (cloning via SSH, generating the Bash prompt) cannot be interrupted by Ctrl+C, which <a href="https://github.com/git-for-windows/msys2-runtime/pull/104">has been fixed</a>.</li>
<li>Git for Windows v2.50.0 is <a href="https://github.com/git-for-windows/git/issues/5695">unable to initialize Git repositories on Windows Server 2016</a>, which has been <a href="https://github.com/git-for-windows/git/pull/5700">fixed</a>.</li>
</ul>

</div><h2 id="v2.50.0" nr="3" class="collapsible"> Changes in v2.50.0<br /><small>since  v2.49.0 (March 17th 2025)</h2></small><div>

<h3>New Features</h3>

<ul>
<li>Comes with <a href="https://github.com/git/git/blob/v2.50.0/Documentation/RelNotes/2.50.0.adoc">Git v2.50.0</a>.</li>
<li>Comes with <a href="https://github.com/mintty/mintty/releases/tag/3.7.8">MinTTY v3.7.8</a>.</li>
<li>Comes with <a href="https://github.com/openssh/openssh-portable/releases/tag/V_10_0_P1">OpenSSH v10.0.P1</a>.</li>
<li>Comes with <a href="https://curl.se/changes.html#8_14_1">cURL v8.14.1</a>.</li>
<li>Comes with the MSYS2 runtime (Git for Windows flavor) based on <a href="https://inbox.sourceware.org/cygwin-announce/302f8026-fbe9-4c21-86cd-5fac1a45085f@dronecode.org.uk/">Cygwin v3.6.3</a>.</li>
</ul>

<h3>Bug Fixes</h3>

<ul>
<li>On Windows Server 2022, Git v2.48.1 introduced a regression where it <a href="https://github.com/git-for-windows/git/issues/5427">failed to write files on ReFS drives</a>, which was <a href="https://github.com/git-for-windows/git/pull/5515">fixed</a>.</li>
<li><a href="https://github.com/git-for-windows/git/issues/5476">Git for Windows 2.48.1 introduced a regression</a> when fetching long branches under <code>core.longPaths = true</code>, which <a href="https://github.com/git-for-windows/git/pull/5550">was fixed</a>.</li>
<li>Git for Windows' installer <a href="https://github.com/git-for-windows/git/issues/5618">used a non-writable file</a> for testing custom editors, which <a href="https://github.com/git-for-windows/build-extra/pull/618">was fixed</a>.</li>
</ul>

</div><h2 id="v2.49.0" nr="4" class="collapsible"> Changes in v2.49.0<br /><small>since  v2.48.1 (February 13th 2025)</h2></small><div>
...
<p>Git for Windows v2.48.1 was the last version to ship with the i686 ("32-bit") variant of the installer, portable Git and archive. Only 32-bit MinGit will be built for future versions, <a href="https://gitforwindows.org/32-bit">until April 2029</a>.</p>

<h3>New Features</h3>

<ul>
<li>Comes with <a href="https://github.com/git/git/blob/v2.49.0/Documentation/RelNotes/2.49.0.adoc">Git v2.49.0</a>.</li>
<li>Comes with <a href="https://github.com/openssh/openssh-portable/releases/tag/V_9_9_P2">OpenSSH v9.9.P2</a>.</li>
<li>Comes with <a href="https://github.com/PCRE2Project/pcre2/releases/tag/pcre2-10.45">PCRE2 v10.45</a>.</li>
<li>The previously-experimental <code>--full-name-hash</code> option has been accepted into upstream Git as <code>--name-hash-version=2</code> and is no longer experimental.</li>
<li>The <code>git backfill</code> command has been accepted into upstream Git; Its <code>--batch-size=&lt;n&gt;</code> option has been renamed to <code>--min-batch-size=&lt;n&gt;</code>, though.</li>
</ul>

<h3>Bug Fixes</h3>

<ul>
<li>A change in upstream Git v2.48.0 broke renaming symlinks, which <a href="https://github.com/git-for-windows/git/pull/5437">was fixed</a>.</li>
<li>On a recent Insider Windows version, <a href="https://github.com/git-for-windows/git/issues/5447">users experienced the message: "Cygwin WARNING: Couldn't compute FAST_CWD pointer"</a>, which has been fixed.</li>
<li>A bug has been <a href="https://github.com/git-for-windows/msys2-runtime/pull/87">fixed</a> that, when calling <code>git add -p</code> from VS Code's internal terminal, after using the <code>e</code>dit command, caused <a href="https://github.com/git-for-windows/git/issues/4776">the internal terminal got stuck</a> and no further command was accepted.</li>
<li>The <a href="https://github.com/git-for-windows/git/issues/5462">syntax highlighting of the <code>nano</code> editor was recently disabled</a> in Git for Windows by mistake, which <a href="https://github.com/git-for-windows/build-extra/pull/605">was fixed</a>.</li>
</ul>

</div><h2 id="v2.48.1" nr="5" class="collapsible"> Changes in v2.48.1<br /><small>since  v2.47.1(2) (January 14th 2025)</h2></small><div>
...
</div><h2 id="v2.47.1(2)" nr="6" class="collapsible"> Changes in v2.47.1(2)<br /><small>since  v2.47.1 (November 25th 2024)</h2></small><div>
...
</div><h2 id="v2.47.1" nr="7" class="collapsible"> Changes in v2.47.1<br /><small>since  v2.47.0(2) (October 22nd 2024)</h2></small><div>
...
</div><h2 id="v2.47.0(2)" nr="8" class="collapsible"> Changes in v2.47.0(2)<br /><small>since  v2.47.0 (October 8th 2024)</h2></small><div>
...
</div><h2 id="v2.47.0" nr="9" class="collapsible"> Changes in v2.47.0<br /><small>since  v2.46.2 (September 24th 2024)</h2></small><div>
...
</div><h2 id="v2.46.2" nr="10" class="collapsible"> Changes in v2.46.2<br /><small>since  v2.46.1 (September 18th 2024)</h2></small><div>
...
</div><h2 id="v2.46.1" nr="11" class="collapsible"> Changes in v2.46.1<br /><small>since  v2.46.0 (July 29th 2024)</h2></small><div>
...
</div><h2 id="v2.46.0" nr="12" class="collapsible"> Changes in v2.46.0<br /><small>since  v2.45.2 (June 3rd 2024)</h2></small><div>
...
</div><h2 id="v2.45.2" nr="13" class="collapsible"> Changes in v2.45.2<br /><small>since  v2.45.1 (May 14th 2024)</h2></small><div>
...
</div><h2 id="v2.45.1" nr="14" class="collapsible"> Changes in v2.45.1<br /><small>since  v2.45.0 (April 29th 2024)</h2></small><div>
...
</div><h2 id="v2.45.0" nr="15" class="collapsible"> Changes in v2.45.0<br /><small>since  v2.44.0 (February 23rd 2024)</h2></small><div>
...
</div><h2 id="v2.44.0" nr="16" class="collapsible"> Changes in v2.44.0<br /><small>since  v2.43.0 (November 20th 2023)</h2></small><div>
...
</div><h2 id="v2.43.0" nr="17" class="collapsible"> Changes in v2.43.0<br /><small>since  v2.42.0(2) (August 30th 2023)</h2></small><div>
...
</div><h2 id="v2.42.0(2)" nr="18" class="collapsible"> Changes in v2.42.0(2)<br /><small>since  v2.42.0 (August 21st 2023)</h2></small><div>
...
</div><h2 id="v2.42.0" nr="19" class="collapsible"> Changes in v2.42.0<br /><small>since  v2.41.0(3) (July 13th 2023)</h2></small><div>
...
</div><h2 id="v2.41.0(3)" nr="20" class="collapsible"> Changes in v2.41.0(3)<br /><small>since  v2.41.0(2) (July 7th 2023)</h2></small><div>
...
</div><h2 id="v2.41.0(2)" nr="21" class="collapsible"> Changes in v2.41.0(2)<br /><small>since  v2.41.0 (June 1st 2023)</h2></small><div>
...
</div><h2 id="v2.41.0" nr="22" class="collapsible"> Changes in v2.41.0<br /><small>since  v2.40.1 (April 25th 2023)</h2></small><div>
...
</div><h2 id="v2.40.1" nr="23" class="collapsible"> Changes in v2.40.1<br /><small>since  v2.40.0 (March 14th 2023)</h2></small><div>
...
</div><h2 id="v2.40.0" nr="24" class="collapsible"> Changes in v2.40.0<br /><small>since  v2.39.2 (February 14th 2023)</h2></small><div>
...
</div><h2 id="v2.39.2" nr="25" class="collapsible"> Changes in v2.39.2<br /><small>since  v2.39.1 (January 17th 2023)</h2></small><div>
...
</div><h2 id="v2.39.1" nr="26" class="collapsible"> Changes in v2.39.1<br /><small>since  v2.39.0(2) (December 21st 2022)</h2></small><div>
...
</div><h2 id="v2.39.0(2)" nr="27" class="collapsible"> Changes in v2.39.0(2)<br /><small>since  v2.39.0 (December 12th 2022)</h2></small><div>
...
</div><h2 id="v2.39.0" nr="28" class="collapsible"> Changes in v2.39.0<br /><small>since  v2.38.1 (October 18th 2022)</h2></small><div>
...
</div><h2 id="v2.38.1" nr="29" class="collapsible"> Changes in v2.38.1<br /><small>since  v2.38.0 (October 3rd 2022)</h2></small><div>
...
</div><h2 id="v2.38.0" nr="30" class="collapsible"> Changes in v2.38.0<br /><small>since  v2.37.3 (August 30th 2022)</h2></small><div>
...
</div><h2 id="v2.37.3" nr="31" class="collapsible"> Changes in v2.37.3<br /><small>since  v2.37.2(2) (August 11th 2022)</h2></small><div>
...
</div><h2 id="v2.37.2(2)" nr="32" class="collapsible"> Changes in v2.37.2(2)<br /><small>since  v2.37.1 (July 12th 2022)</h2></small><div>
...
</div><h2 id="v2.37.1" nr="33" class="collapsible"> Changes in v2.37.1<br /><small>since  v2.37.0 (June 27th 2022)</h2></small><div>
...
</div><h2 id="v2.37.0" nr="34" class="collapsible"> Changes in v2.37.0<br /><small>since  v2.36.1 (May 9th 2022)</h2></small><div>
...
</div><h2 id="v2.36.1" nr="35" class="collapsible"> Changes in v2.36.1<br /><small>since  v2.36.0 (April 20th 2022)</h2></small><div>
...
</div><h2 id="v2.36.0" nr="36" class="collapsible"> Changes in v2.36.0<br /><small>since  v2.35.3 (April 15th 2022)</h2></small><div>

<p>This version includes Git LFS v3.1.4, addressing <a href="https://github.com/git-lfs/git-lfs/security/advisories/GHSA-6rw3-3whw-jvjj">CVE-2022-24826</a> (if you use Git LFS with <a href="https://gitforwindows.org/mingit">MinGit</a>, you will want to upgrade).</p>
...
</div><h2 id="v2.35.3" nr="37" class="collapsible"> Changes in v2.35.3<br /><small>since  v2.35.2 (April 12th 2022)</h2></small><div>
...
</div><h2 id="v2.35.2" nr="38" class="collapsible"> Changes in v2.35.2<br /><small>since  v2.35.1(2) (February 1st 2022)</h2></small><div>
...
</div><h2 id="v2.35.1(2)" nr="39" class="collapsible"> Changes in v2.35.1(2)<br /><small>since  v2.35.1 (January 29th 2022)</h2></small><div>
...
</div><h2 id="v2.35.1" nr="40" class="collapsible"> Changes in v2.35.1<br /><small>since  v2.35.0 (January 24th 2022)</h2></small><div>
...
</div><h2 id="v2.35.0" nr="41" class="collapsible"> Changes in v2.35.0<br /><small>since  v2.34.1 (November 25th 2021)</h2></small><div>
...
</div><h2 id="v2.34.1" nr="42" class="collapsible"> Changes in v2.34.1<br /><small>since  v2.34.0 (November 15th 2021)</h2></small><div>
...
</div><h2 id="v2.34.0" nr="43" class="collapsible"> Changes in v2.34.0<br /><small>since  v2.33.1 (October 13th 2021)</h2></small><div>
...
</div><h2 id="v2.33.1" nr="44" class="collapsible"> Changes in v2.33.1<br /><small>since  v2.33.0(2) (August 24th 2021)</h2></small><div>
...
</div><h2 id="v2.33.0(2)" nr="45" class="collapsible"> Changes in v2.33.0(2)<br /><small>since  v2.33.0 (August 17th 2021)</h2></small><div>
...
</div><h2 id="v2.33.0" nr="46" class="collapsible"> Changes in v2.33.0<br /><small>since  v2.32.0(2) (July 6th 2021)</h2></small><div>
...
</div><h2 id="v2.32.0(2)" nr="47" class="collapsible"> Changes in v2.32.0(2)<br /><small>since  v2.32.0 (June 7th 2021)</h2></small><div>
...
</div><h2 id="v2.32.0" nr="48" class="collapsible"> Changes in v2.32.0<br /><small>since  v2.31.1 (March 27th 2021)</h2></small><div>
...
</div><h2 id="v2.31.1" nr="49" class="collapsible"> Changes in v2.31.1<br /><small>since  v2.31.0 (March 15th 2021)</h2></small><div>
...
</div><h2 id="v2.31.0" nr="50" class="collapsible"> Changes in v2.31.0<br /><small>since  v2.30.2 (March 9th 2021)</h2></small><div>
...
</div><h2 id="v2.30.2" nr="51" class="collapsible"> Changes in v2.30.2<br /><small>since  v2.30.1 (February 9th 2021)</h2></small><div>
...
</div><h2 id="v2.30.1" nr="52" class="collapsible"> Changes in v2.30.1<br /><small>since  v2.30.0(2) (January 14th 2021)</h2></small><div>
...
</div><h2 id="v2.30.0(2)" nr="53" class="collapsible"> Changes in v2.30.0(2)<br /><small>since  v2.30.0 (December 28th 2020)</h2></small><div>
...
</div><h2 id="v2.30.0" nr="54" class="collapsible"> Changes in v2.30.0<br /><small>since  v2.29.2(3) (December 8th 2020)</h2></small><div>
...
</div><h2 id="v2.29.2(3)" nr="55" class="collapsible"> Changes in v2.29.2(3)<br /><small>since  v2.29.2(2) (November 4th 2020)</h2></small><div>
...
</div><h2 id="v2.29.2(2)" nr="56" class="collapsible"> Changes in v2.29.2(2)<br /><small>since  v2.29.2 (October 30th 2020)</h2></small><div>
...
</div><h2 id="v2.29.2" nr="57" class="collapsible"> Changes in v2.29.2<br /><small>since  v2.29.1 (October 23rd 2020)</h2></small><div>
...
</div><h2 id="v2.29.1" nr="58" class="collapsible"> Changes in v2.29.1<br /><small>since  v2.29.0 (October 19th 2020)</h2></small><div>
...
</div><h2 id="v2.29.0" nr="59" class="collapsible"> Changes in v2.29.0<br /><small>since  v2.28.0 (July 28th 2020)</h2></small><div>
...
</div><h2 id="v2.28.0" nr="60" class="collapsible"> Changes in v2.28.0<br /><small>since  v2.27.0 (June 1st 2020)</h2></small><div>
...
</div><h2 id="v2.27.0" nr="61" class="collapsible"> Changes in v2.27.0<br /><small>since  v2.26.2 (April 20th 2020)</h2></small><div>
...
</div><h2 id="v2.26.2" nr="62" class="collapsible"> Changes in v2.26.2<br /><small>since  v2.26.1 (April 9th 2020)</h2></small><div>
...
</div><h2 id="v2.26.1" nr="63" class="collapsible"> Changes in v2.26.1<br /><small>since  v2.26.0 (March 23rd 2020)</h2></small><div>
...
</div><h2 id="v2.26.0" nr="64" class="collapsible"> Changes in v2.26.0<br /><small>since  v2.25.1 (February 19th 2020)</h2></small><div>
...
</div><h2 id="v2.25.1" nr="65" class="collapsible"> Changes in v2.25.1<br /><small>since  v2.25.0 (January 13th 2020)</h2></small><div>
...
</div><h2 id="v2.25.0" nr="66" class="collapsible"> Changes in v2.25.0<br /><small>since  v2.24.1(2) (December 10th 2019)</h2></small><div>
...
</div><h2 id="v2.24.1(2)" nr="67" class="collapsible"> Changes in v2.24.1(2)<br /><small>since  v2.24.0(2) (November 6th 2019)</h2></small><div>
...
</div><h2 id="v2.24.0(2)" nr="68" class="collapsible"> Changes in v2.24.0(2)<br /><small>since  v2.24.0 (November 4th 2019)</h2></small><div>
...
</div><h2 id="v2.24.0" nr="69" class="collapsible"> Changes in v2.24.0<br /><small>since  v2.23.0 (August 17th 2019)</h2></small><div>
...
</div><h2 id="v2.23.0" nr="70" class="collapsible"> Changes in v2.23.0<br /><small>since  v2.22.0 (June 8th 2019)</h2></small><div>
...
</div><h2 id="v2.22.0" nr="71" class="collapsible"> Changes in v2.22.0<br /><small>since  v2.21.0 (February 26th 2019)</h2></small><div>
...
</div><h2 id="v2.21.0" nr="72" class="collapsible"> Changes in v2.21.0<br /><small>since  v2.20.1 (December 15th 2018)</h2></small><div>
...
</div><h2 id="v2.20.1" nr="73" class="collapsible"> Changes in v2.20.1<br /><small>since  v2.20.0 (December 10th 2018)</h2></small><div>
...
</div><h2 id="v2.20.0" nr="74" class="collapsible"> Changes in v2.20.0<br /><small>since  v2.19.2 (November 21st 2018)</h2></small><div>
...
</div><h2 id="v2.19.2" nr="75" class="collapsible"> Changes in v2.19.2<br /><small>since  v2.19.1 (Oct 5th 2018)</h2></small><div>
...
</div><h2 id="v2.19.1" nr="76" class="collapsible"> Changes in v2.19.1<br /><small>since  v2.19.0 (September 11th 2018)</h2></small><div>
...
</div><h2 id="v2.19.0" nr="77" class="collapsible"> Changes in v2.19.0<br /><small>since  v2.18.0 (June 22nd 2018)</h2></small><div>
...
</div><h2 id="v2.18.0" nr="78" class="collapsible"> Changes in v2.18.0<br /><small>since  v2.17.1(2) (May 29th 2018)</h2></small><div>
...
</div><h2 id="v2.17.1(2)" nr="79" class="collapsible"> Changes in v2.17.1(2)<br /><small>since  v2.17.1 (May 29th 2018)</h2></small><div>
...
</div><h2 id="v2.17.1" nr="80" class="collapsible"> Changes in v2.17.1<br /><small>since  v2.17.0 (April 3rd 2018)</h2></small><div>
...
</div><h2 id="v2.17.0" nr="81" class="collapsible"> Changes in v2.17.0<br /><small>since  v2.16.3 (March 23rd 2018)</h2></small><div>
...
</div><h2 id="v2.16.3" nr="82" class="collapsible"> Changes in v2.16.3<br /><small>since  v2.16.2 (February 20th 2018)</h2></small><div>
...
</div><h2 id="v2.16.2" nr="83" class="collapsible"> Changes in v2.16.2<br /><small>since  v2.16.1(4) (February 7th 2018)</h2></small><div>
...
</div><h2 id="v2.16.1(4)" nr="84" class="collapsible"> Changes in v2.16.1(4)<br /><small>since  v2.16.1(3) (February 6th 2018)</h2></small><div>
...
</div><h2 id="v2.16.1(3)" nr="85" class="collapsible"> Changes in v2.16.1(3)<br /><small>since  v2.16.1(2) (February 2nd 2018)</h2></small><div>
...
</div><h2 id="v2.16.1(2)" nr="86" class="collapsible"> Changes in v2.16.1(2)<br /><small>since  v2.16.1 (January 22nd 2018)</h2></small><div>
...
</div><h2 id="v2.16.1" nr="87" class="collapsible"> Changes in v2.16.1<br /><small>since  v2.16.0(2) (January 18th 2018)</h2></small><div>
...
</div><h2 id="v2.16.0(2)" nr="88" class="collapsible"> Changes in v2.16.0(2)<br /><small>since  v2.15.1(2) (November 30th 2017)</h2></small><div>
...
</div><h2 id="v2.15.1(2)" nr="89" class="collapsible"> Changes in v2.15.1(2)<br /><small>since  v2.15.1 (November 29th 2017)</h2></small><div>
...
</div><h2 id="v2.15.1" nr="90" class="collapsible"> Changes in v2.15.1<br /><small>since  v2.15.0 (October 30th 2017)</h2></small><div>
...
</div><h2 id="v2.15.0" nr="91" class="collapsible"> Changes in v2.15.0<br /><small>since  v2.14.3 (October 23rd 2017)</h2></small><div>
...
</div><h2 id="v2.14.3" nr="92" class="collapsible"> Changes in v2.14.3<br /><small>since  v2.14.2(3) (October 12th 2017)</h2></small><div>
...
</div><h2 id="v2.14.2(3)" nr="93" class="collapsible"> Changes in v2.14.2(3)<br /><small>since  v2.14.2(2) (October 5th 2017)</h2></small><div>
...
</div><h2 id="v2.14.2(2)" nr="94" class="collapsible"> Changes in v2.14.2(2)<br /><small>since  v2.14.2 (September 26th 2017)</h2></small><div>
...
</div><h2 id="v2.14.2" nr="95" class="collapsible"> Changes in v2.14.2<br /><small>since  v2.14.1 (August 10th 2017)</h2></small><div>
...
</div><h2 id="v2.14.1" nr="96" class="collapsible"> Changes in v2.14.1<br /><small>since  v2.14.0(2) (August 7th 2017)</h2></small><div>
...
</div><h2 id="v2.14.0(2)" nr="97" class="collapsible"> Changes in v2.14.0(2)<br /><small>since  v2.14.0 (August 6th 2017)</h2></small><div>
...
</div><h2 id="v2.14.0" nr="98" class="collapsible"> Changes in v2.14.0<br /><small>since  v2.13.3 (July 13th 2017)</h2></small><div>
...
<li>Git for Windows releases now also include an experimental <a href="https://gitforwindows.org/mingit#experimental-busybox-based-mingit">BusyBox-based MinGit</a>.</li>
</ul>
...
</div><h2 id="v2.13.3" nr="99" class="collapsible"> Changes in v2.13.3<br /><small>since  v2.13.2 (June 26th 2017)</h2></small><div>
...
</div><h2 id="v2.13.2" nr="100" class="collapsible"> Changes in v2.13.2<br /><small>since  v2.13.1(2) (June 15th 2017)</h2></small><div>
...
</div><h2 id="v2.13.1(2)" nr="101" class="collapsible"> Changes in v2.13.1(2)<br /><small>since  v2.13.1 (June 13th 2017)</h2></small><div>
...
</div><h2 id="v2.13.1" nr="102" class="collapsible"> Changes in v2.13.1<br /><small>since  v2.13.0 (May 10th 2017)</h2></small><div>
...
</div><h2 id="v2.13.0" nr="103" class="collapsible"> Changes in v2.13.0<br /><small>since  v2.12.2(2) (April 5th 2017)</h2></small><div>
...
</div><h2 id="v2.12.2(2)" nr="104" class="collapsible"> Changes in v2.12.2(2)<br /><small>since  v2.12.2 (March 27th 2017)</h2></small><div>
...
</div><h2 id="v2.12.2" nr="105" class="collapsible"> Changes in v2.12.2<br /><small>since  v2.12.1 (March 21st 2017)</h2></small><div>
...
</div><h2 id="v2.12.1" nr="106" class="collapsible"> Changes in v2.12.1<br /><small>since  v2.12.0 (February 25th 2017)</h2></small><div>
...
</div><h2 id="v2.12.0" nr="107" class="collapsible"> Changes in v2.12.0<br /><small>since  v2.11.1 (February 3rd 2017)</h2></small><div>
...
</div><h2 id="v2.11.1" nr="108" class="collapsible"> Changes in v2.11.1<br /><small>since  v2.11.0(3) (January 14th 2017)</h2></small><div>
...
</div><h2 id="v2.11.0(3)" nr="109" class="collapsible"> Changes in v2.11.0(3)<br /><small>since  v2.11.0(2) (January 13th 2017)</h2></small><div>
...
</div><h2 id="v2.11.0(2)" nr="110" class="collapsible"> Changes in v2.11.0(2)<br /><small>since  v2.11.0 (December 1st 2016)</h2></small><div>
...
</div><h2 id="v2.11.0" nr="111" class="collapsible"> Changes in v2.11.0<br /><small>since  v2.10.2 (November 2nd 2016)</h2></small><div>
...
</div><h2 id="v2.10.2" nr="112" class="collapsible"> Changes in v2.10.2<br /><small>since  v2.10.1(2) (October 13th 2016)</h2></small><div>
...
</div><h2 id="v2.10.1(2)" nr="113" class="collapsible"> Changes in v2.10.1(2)<br /><small>since  v2.10.1 (October 4th 2016)</h2></small><div>
...
</div><h2 id="v2.10.1" nr="114" class="collapsible"> Changes in v2.10.1<br /><small>since  v2.10.0 (September 3rd 2016)</h2></small><div>
...
</div><h2 id="v2.10.0" nr="115" class="collapsible"> Changes in v2.10.0<br /><small>since  v2.9.3(2) (August 25th 2016)</h2></small><div>
...
</div><h2 id="v2.9.3(2)" nr="116" class="collapsible"> Changes in v2.9.3(2)<br /><small>since  v2.9.3 (August 13th 2016)</h2></small><div>
...
</div><h2 id="v2.9.3" nr="117" class="collapsible"> Changes in v2.9.3<br /><small>since  v2.9.2 (July 16th 2016)</h2></small><div>
...
</div><h2 id="v2.9.2" nr="118" class="collapsible"> Changes in v2.9.2<br /><small>since  v2.9.0 (June 14th 2016)</h2></small><div>
...
</div><h2 id="v2.9.0" nr="119" class="collapsible"> Changes in v2.9.0<br /><small>since  v2.8.4 (June 7th 2016)</h2></small><div>
...
</div><h2 id="v2.8.4" nr="120" class="collapsible"> Changes in v2.8.4<br /><small>since  v2.8.3 (May 20th 2016)</h2></small><div>
...
</div><h2 id="v2.8.3" nr="121" class="collapsible"> Changes in v2.8.3<br /><small>since  v2.8.2 (May 3rd 2016)</h2></small><div>
...
</div><h2 id="v2.8.2" nr="122" class="collapsible"> Changes in v2.8.2<br /><small>since  v2.8.1 (April 4th 2016)</h2></small><div>
...
</div><h2 id="v2.8.1" nr="123" class="collapsible"> Changes in v2.8.1<br /><small>since  v2.8.0 (March 29th 2016)</h2></small><div>
...
</div><h2 id="v2.8.0" nr="124" class="collapsible"> Changes in v2.8.0<br /><small>since  v2.7.4 (March 18th 2016)</h2></small><div>
...
</div><h2 id="v2.7.4" nr="125" class="collapsible"> Changes in v2.7.4<br /><small>since  v2.7.3 (March 15th 2016)</h2></small><div>
...
</div><h2 id="v2.7.3" nr="126" class="collapsible"> Changes in v2.7.3<br /><small>since  v2.7.2 (February 23rd 2016)</h2></small><div>
...
</div><h2 id="v2.7.2" nr="127" class="collapsible"> Changes in v2.7.2<br /><small>since  v2.7.1(2) (February 12th 2016)</h2></small><div>
...
</div><h2 id="v2.7.1(2)" nr="128" class="collapsible"> Changes in v2.7.1(2)<br /><small>since  v2.7.1 (February 6th 2016)</h2></small><div>
...
</div><h2 id="v2.7.1" nr="129" class="collapsible"> Changes in v2.7.1<br /><small>since  v2.7.0(2) (February 2nd 2016)</h2></small><div>
...
</div><h2 id="v2.7.0(2)" nr="130" class="collapsible"> Changes in v2.7.0(2)<br /><small>since  v2.7.0 (January 5th 2016)</h2></small><div>
...
</div><h2 id="v2.7.0" nr="131" class="collapsible"> Changes in v2.7.0<br /><small>since  v2.6.4 (December 14th 2015)</h2></small><div>
...
</div><h2 id="v2.6.4" nr="132" class="collapsible"> Changes in v2.6.4<br /><small>since  v2.6.3 (November 10th 2015)</h2></small><div>
...
</div><h2 id="v2.6.3" nr="133" class="collapsible"> Changes in v2.6.3<br /><small>since  v2.6.2 (October 19th 2015)</h2></small><div>
...
</div><h2 id="v2.6.2" nr="134" class="collapsible"> Changes in v2.6.2<br /><small>since  v2.6.1 (October 5th 2015)</h2></small><div>
...
</div><h2 id="v2.6.1" nr="135" class="collapsible"> Changes in v2.6.1<br /><small>since 2.6.0 (September 29th 2015)</h2></small><div>
...
</div><h2 id="v2.6.0" nr="136" class="collapsible"> Changes in v2.6.0<br /><small>since 2.5.3 (September 18th 2015)</h2></small><div>
...
</div><h2 id="v2.5.3" nr="137" class="collapsible"> Changes in v2.5.3<br /><small>since 2.5.2(2) (September 13th 2015)</h2></small><div>
...
</div><h2 id="v2.5.2(2)" nr="138" class="collapsible"> Changes in v2.5.2(2)<br /><small>since 2.5.2 (September 10th 2015)</h2></small><div>
...
</div><h2 id="v2.5.2" nr="139" class="collapsible"> Changes in v2.5.2<br /><small>since 2.5.1 (August 31th 2015)</h2></small><div>
...
<li>A <a href="https://github.com/git-for-windows/git/issues/361">work around</a> was added for <a href="https://gitforwindows.org/32-bit-issues">issues</a> when installing 32-bit Git for Windows on 64-bit Windows 10.</li>
...
</div><h2 id="v2.5.1" nr="140" class="collapsible"> Changes in v2.5.1<br /><small>since 2.5.0 (August 18th 2015)</h2></small><div>
...
</div><h2 id="v2.5.0" nr="141" class="collapsible"> Changes in v2.5.0<br /><small>since 2.4.6 (July 18th 2015)</h2></small><div>
...
</div><h2 id="v2.4.6" nr="142" class="collapsible"> Changes in v2.4.6<br /><small>since 2.4.5 (June 29th 2015)</h2></small><div>
...
</div><h2 id="v2.4.5" nr="143" class="collapsible"> Changes in v2.4.5<br /><small>since 2.4.4 (June 20th 2015)</h2></small><div>
...
</div><h2 id="v2.4.4" nr="144" class="collapsible"> Changes in v2.4.4<br /><small>since 2.4.3 (June 12th 2015)</h2></small><div>
...
</div><h2 id="v2.4.3" nr="145" class="collapsible"> Changes in v2.4.3<br /><small>since 2.4.2 (May 27th 2015)</h2></small><div>
...
</div><h2 id="v2.4.2" nr="146" class="collapsible"> Changes in v2.4.2<br /><small>since 2.4.1 (May 14th 2015)</h2></small><div>
...
</div><h2 id="v2.4.1" nr="147" class="collapsible"> Changes in v2.4.1<br /><small>since 2.4.0(2) (May 7th 2015)</h2></small><div>
...
</div><h2 id="v2.4.0(2)" nr="148" class="collapsible"> Changes in v2.4.0(2)<br /><small>since 2.4.0 (May 5th 2015)</h2></small><div>
...
</div><h2 id="v2.4.0" nr="149" class="collapsible"> Changes in v2.4.0<br /><small>since 2.3.7-preview20150429</h2></small><div>
...
</div><h2 id="v2.3.7-preview20150429" nr="150" class="collapsible"> Changes in v2.3.7-preview20150429<br /><small>since 2.3.6-preview20150425</h2></small><div>
...
</div><h2 id="v2.3.6-preview20150425" nr="151" class="collapsible"> Changes in v2.3.6-preview20150425<br /><small>since 2.3.5-preview20150402</h2></small><div>
...
</div><h2 id="v2.3.5-preview20150402" nr="152" class="collapsible"> Changes in v2.3.5-preview20150402<br /><small>since 1.9.5-preview20150402</h2></small><div>
...
</div><h2 id="v1.9.5-preview20150402" nr="153" class="collapsible"> Changes in v1.9.5-preview20150402<br /><small>since 1.9.5-preview20141217</h2></small><div>
...
</div><h2 id="v1.9.5-preview20141217" nr="154" class="collapsible"> Changes in v1.9.5-preview20141217<br /><small>since 1.9.4-preview20140929</h2></small><div>
...
</div><h2 id="v1.9.4-preview20140929" nr="155" class="collapsible"> Changes in v1.9.4-preview20140929<br /><small>since 1.9.4-preview20140815</h2></small><div>
...
</div><h2 id="v1.9.4-preview20140815" nr="156" class="collapsible"> Changes in v1.9.4-preview20140815<br /><small>since 1.9.4-preview20140611</h2></small><div>
...
</div><h2 id="v1.9.4-preview20140611" nr="157" class="collapsible"> Changes in v1.9.4-preview20140611<br /><small>since 1.9.2-preview20140411</h2></small><div>
...
</div><h2 id="v1.9.2-preview20140411" nr="158" class="collapsible"> Changes in v1.9.2-preview20140411<br /><small>since 1.9.0-preview20140217</h2></small><div>
...
</div><h2 id="v1.9.0-preview20140217" nr="159" class="collapsible"> Changes in v1.9.0-preview20140217<br /><small>since 1.8.5.2-preview20131230</h2></small><div>
...
</div><h2 id="v1.8.5.2-preview20131230" nr="160" class="collapsible"> Changes in v1.8.5.2-preview20131230<br /><small>since 1.8.4-preview20130916</h2></small><div>
...
</div><h2 id="v1.8.4-preview20130916" nr="161" class="collapsible"> Changes in v1.8.4-preview20130916<br /><small>since 1.8.3-preview20130601</h2></small><div>
...
</div><h2 id="v1.8.3-preview20130601" nr="162" class="collapsible"> Changes in v1.8.3-preview20130601<br /><small>since 1.8.1.2-preview20130201</h2></small><div>
...
</div><h2 id="v1.8.1.2-preview20130201" nr="163" class="collapsible"> Changes in v1.8.1.2-preview20130201<br /><small>since 1.8.0-preview20121022</h2></small><div>
...
</div><h2 id="v1.8.0-preview20121022" nr="164" class="collapsible"> Changes in v1.8.0-preview20121022<br /><small>since 1.7.11-preview20120710</h2></small><div>
...
</div><h2 id="v1.7.11-preview20120710" nr="165" class="collapsible"> Changes in v1.7.11-preview20120710<br /><small>since 1.7.11-preview20120704</h2></small><div>
...
</div><h2 id="v1.7.11-preview20120704" nr="166" class="collapsible"> Changes in v1.7.11-preview20120704<br /><small>since 1.7.11-preview20120620</h2></small><div>
...
</div><h2 id="v1.7.11-preview20120620" nr="167" class="collapsible"> Changes in v1.7.11-preview20120620<br /><small>since 1.7.10-preview20120409</h2></small><div>
...
</div><h2 id="v1.7.10-preview20120409" nr="168" class="collapsible"> Changes in v1.7.10-preview20120409<br /><small>since 1.7.9-preview20120201</h2></small><div>
...
</div><h2 id="v1.7.9-preview20120201" nr="169" class="collapsible"> Changes in v1.7.9-preview20120201<br /><small>since 1.7.8-preview20111206</h2></small><div>
...
</div><h2 id="v1.7.8-preview20111206" nr="170" class="collapsible"> Changes in v1.7.8-preview20111206<br /><small>since 1.7.7.1-preview20111027</h2></small><div>
...
</div><h2 id="v1.7.7.1-preview20111027" nr="171" class="collapsible"> Changes in v1.7.7.1-preview20111027<br /><small>since 1.7.7-preview20111014</h2></small><div>
...
</div><h2 id="v1.7.7-preview20111014" nr="172" class="collapsible"> Changes in v1.7.7-preview20111014<br /><small>since 1.7.6-preview20110708</h2></small><div>
...
</div><h2 id="v1.7.6-preview20110708" nr="173" class="collapsible"> Changes in v1.7.6-preview20110708<br /><small>since 1.7.4-preview20110211</h2></small><div>
...
</div><h2 id="v1.7.4-preview20110211" nr="174" class="collapsible"> Changes in v1.7.4-preview20110211<br /><small>since 1.7.3.2-preview20101025</h2></small><div>
...
</div><h2 id="v1.7.3.2-preview20101025" nr="175" class="collapsible"> Changes in v1.7.3.2-preview20101025<br /><small>since 1.7.3.1-preview20101002</h2></small><div>
...
</div><h2 id="v1.7.3.1-preview20101002" nr="176" class="collapsible"> Changes in v1.7.3.1-preview20101002<br /><small>since 1.7.2.3-preview20100911</h2></small><div>
...
</div><h2 id="v1.7.2.3-preview20100911" nr="177" class="collapsible"> Changes in v1.7.2.3-preview20100911<br /><small>since 1.7.1-preview20100612</h2></small><div>
...
</div><h2 id="v1.7.1-preview20100612" nr="178" class="collapsible"> Changes in v1.7.1-preview20100612<br /><small>since 1.7.0.2-preview20100309</h2></small><div>
...
</div><h2 id="v1.7.0.2-preview20100309" nr="179" class="collapsible"> Changes in v1.7.0.2-preview20100309<br /><small>since 1.6.5.1-preview20091022</h2></small><div>
...
</div><h2 id="v1.6.5.1-preview20091022" nr="180" class="collapsible"> Changes in v1.6.5.1-preview20091022<br /><small>since 1.6.4-preview20090729</h2></small><div>
...
</div><h2 id="v1.6.4-preview20090729" nr="181" class="collapsible"> Changes in v1.6.4-preview20090729<br /><small>since 1.6.3.2-preview20090608</h2></small><div>
...
</div><h2 id="v1.6.3.2-preview20090608" nr="182" class="collapsible"> Changes in v1.6.3.2-preview20090608<br /><small>since 1.6.3-preview20090507</h2></small><div>
...
</div><h2 id="v1.6.3-preview20090507" nr="183" class="collapsible"> Changes in v1.6.3-preview20090507<br /><small>since 1.6.2.2-preview20090408</h2></small><div>
...
</div><h2 id="v1.6.2.2-preview20090408" nr="184" class="collapsible"> Changes in v1.6.2.2-preview20090408<br /><small>since 1.6.2.1-preview20090322</h2></small><div>
...
</div><h2 id="v1.6.2.1-preview20090322" nr="185" class="collapsible"> Changes in v1.6.2.1-preview20090322<br /><small>since 1.6.2-preview20090308</h2></small><div>
...
</div><h2 id="v1.6.2-preview20090308" nr="186" class="collapsible"> Changes in v1.6.2-preview20090308<br /><small>since 1.6.1-preview20081225</h2></small><div>
...
</div><h2 id="v1.6.1-preview20081225" nr="187" class="collapsible"> Changes in v1.6.1-preview20081225<br /><small>since 1.6.0.2-preview20080923</h2></small><div>
...
</div><h2 id="v1.6.0.2-preview20080923" nr="188" class="collapsible"> Changes in v1.6.0.2-preview20080923<br /><small>since 1.6.0.2-preview20080921</h2></small><div>
...
</div><h2 id="v1.6.0.2-preview20080921" nr="189" class="collapsible"> Changes in v1.6.0.2-preview20080921<br /><small>since 1.5.6.1-preview20080701</h2></small><div>
...
</div><h2 id="v1.5.6.1-preview20080701" nr="190" class="collapsible"> Changes in v1.5.6.1-preview20080701<br /><small>since 1.5.6-preview20080622</h2></small><div>
...
</div><h2 id="v1.5.6-preview20080622" nr="191" class="collapsible"> Changes in v1.5.6-preview20080622<br /><small>since 1.5.5-preview20080413</h2></small><div>
...
</div><h2 id="v1.5.5-preview20080413" nr="192" class="collapsible"> Changes in v1.5.5-preview20080413<br /><small>since 1.5.4-preview20080202</h2></small><div>
...
</div><h2 id="v1.5.4-preview20080202" nr="193" class="collapsible"> Changes in v1.5.4-preview20080202<br /><small>since 1.5.3.6-preview20071126</h2></small><div>
...
</div><h2 id="v1.5.3.6-preview20071126" nr="194" class="collapsible"> Changes in v1.5.3.6-preview20071126<br /><small>since 1.5.3.5-preview20071114</h2></small><div>
...
</div><h2 id="v1.5.3.5-preview20071114" nr="195" class="collapsible"> Changes in v1.5.3.5-preview20071114<br /><small>since 1.5.3-preview20071027</h2></small><div>
...
</div><h2 id="v1.5.3-preview20071027" nr="196" class="collapsible"> Changes in v1.5.3-preview20071027<br /><small>since 1.5.3-preview20071019</h2></small><div>
...
</div><h2 id="v1.5.3-preview20071019" nr="197" class="collapsible"> Changes since WinGit-0.2-alpha</h2><div>
